...
//	var_page:分页变量,
//	list_rows:每页数量
func (pagination *Pagination) Paginate(seter *gorm.DB, listRows int, parameters url.Values) *gorm.DB {
	...
	return seter.Offset((pagination.CurrentPage - 1) * pagination.ListRows).Limit(pagination.ListRows)
}
