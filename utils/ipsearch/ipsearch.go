...
var ipdataFilePath = "./utils/ipsearch/qqzeng-ip-utf8.dat"
...
var IpSearch *ipSearch = nil

func Init() error {
	fmt.Println("ipSearch init........")
	if IpSearch == nil {
		var err error
		IpSearch, err = loadIpDat()
		if err != nil {
			return err
		}
	}
...
//		ips, err = loadIpDat()
//		if err != nil {
//			beego.Error("the IP Dat loaded failed!")
//			return *ips, err
//		}
//	}
//	return *ips, nil
...
func loadIpDat() (*ipSearch, error) {
	...
	//加载ip地址库信息
	// pwd, _ := os.Getwd()
	data, err := os.ReadFile(ipdataFilePath)
	if err != nil {
		return nil, err
	}
	p.data = data
